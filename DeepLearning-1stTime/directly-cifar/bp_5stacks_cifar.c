/*
  ...
  ./cifar_test 
  gcc -O3 -std=c99 -Wall -I ~ya000836/usr/include/ -I SFMT-src-1.5.1 -D SFMT_MEXP=19937 -o rec_cifar rec_cifar.c cifar.c SFMT-src-1.5.1/SFMT.c -lm
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
int main(void)
{
  ...
  createLayer ( &network, 4, CIFAR_LABEL_SIZE );
