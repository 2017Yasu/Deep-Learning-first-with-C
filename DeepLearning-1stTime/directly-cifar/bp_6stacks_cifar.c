...
int main(void)
{
  ...
  createLayer ( &network4, 2, 64 );
  createLayer ( &network4, 3, 32 );
  createLayer ( &network4, 4, 16 );
  createLayer ( &network4, 5, 32 );
  ...
  copyConnection(&network4, 0, &network, 0); // copy weight of network3
  copyConnection(&network4, 1, &network, 1); // copy weight of network3
  copyConnection(&network4, 2, &network, 2); // copy weight of network3
  copyConnection(&network4, 3, &network, 3); // copy weight of network3
