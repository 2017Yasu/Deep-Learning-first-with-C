...
int main(void)
{
  ...
  createLayer ( &network5, 4, 32 );
  createLayer ( &network5, 5, 16 );
  createLayer ( &network5, 6, 32 );
  ...
  createNetwork ( &network, 7, rng );
  createLayer ( &network, 0, CIFAR_IMAGE_SIZE );
  createLayer ( &network, 1, 128 );
  createLayer ( &network, 2, 96 );
  createLayer ( &network, 3, 64 );
  createLayer ( &network, 4, 32 );
  createLayer ( &network, 5, 16 );
  createLayer ( &network, 6, CIFAR_LABEL_SIZE );
  ...
  copyConnection(&network5, 0, &network, 0); // copy weight of network4
  copyConnection(&network5, 1, &network, 1); // copy weight of network4
  copyConnection(&network5, 2, &network, 2); // copy weight of network4
  copyConnection(&network5, 3, &network, 3); // copy weight of network4
  copyConnection(&network5, 4, &network, 4); // copy weight of network4
