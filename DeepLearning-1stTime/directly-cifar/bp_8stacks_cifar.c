...
int main(void)
{
  ...
  createLayer ( &network, 6, 16 );
  createLayer ( &network, 7, CIFAR_LABEL_SIZE );
  ...
  copyConnection(&network6, 0, &network, 0); // copy weight of network5
  copyConnection(&network6, 1, &network, 1); // copy weight of network5
  copyConnection(&network6, 2, &network, 2); // copy weight of network5
  copyConnection(&network6, 3, &network, 3); // copy weight of network5
  copyConnection(&network6, 4, &network, 4); // copy weight of network5
  copyConnection(&network6, 5, &network, 5); // copy weight of network5
