...
int main(void)
{
  ...
  createLayer ( &network, 8, CIFAR_LABEL_SIZE );
  ...
  copyConnection(&network7, 0, &network, 0); // copy weight of network6
  copyConnection(&network7, 1, &network, 1); // copy weight of network6
  copyConnection(&network7, 2, &network, 2); // copy weight of network6
  copyConnection(&network7, 3, &network, 3); // copy weight of network6
  copyConnection(&network7, 4, &network, 4); // copy weight of network6
  copyConnection(&network7, 5, &network, 5); // copy weight of network6
  copyConnection(&network7, 6, &network, 6); // copy weight of network6
